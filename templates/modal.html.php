      ...
      <form id="fancy-lifesaver-form">
        ...
        <div class="fancy-lifesaver__modal-field required">
          ...
          <?php
            ...
            printf(__('You agree to send information to the address %s about your website (url, version of the template and plugins, PHP version and information about your browser) and data from this form. The information you submit will be needed to diagnose the problem.', 'fancy-lifesaver'), 'aaa');
          ?>
          </label>
        </div>
